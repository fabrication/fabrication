...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.intro {
	 ...
	 */
	public class DefaultFlexApplicationStartupCommand extends SimpleFabricationCommand {
		
		/**
		 * Adds the DefaultFlexIntroPanel to the current application. 
		 */
		override public function execute(note:INotification):void {
			var app:FlexApplication = note.getBody() as FlexApplication;

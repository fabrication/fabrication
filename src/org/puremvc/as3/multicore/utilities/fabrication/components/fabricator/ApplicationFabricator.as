		...
		protected function initializeFabricator():void {
			if (_startupCommand == null) {
				try {
					...
					var startupCommandClass:Class = getDefinitionByName("org.puremvc.as3.multicore.utilities.fabrication.addons.module.EmptyFlexModuleStartupCommand") as Class;
					if (startupCommandClass != null) {
						_startupCommand = startupCommandClass;
					};
				} finally {

...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.undoable {
	...
	public class FabricationUndoCommandTest extends AbstractFabricationCommandTest {
		...
		public function FabricationUndoCommandTest(method:String) {
			super(method);
		}
		...
		public function testFabricationUndoCommandHasValidType():void {
			assertType(FabricationUndoCommand, command);
			assertType(SimpleFabricationCommand, command);
		}
		
		public function testFabricationUndoCommandInvokesUndoOnFacadeWithNoArgsWhenStepsAreNotSpecified():void {
		...
		public function testFabricationUndoCommandInvokesUndoOnFacadeWithSpecifiedStepsWhenStepsAreSpecified():void {

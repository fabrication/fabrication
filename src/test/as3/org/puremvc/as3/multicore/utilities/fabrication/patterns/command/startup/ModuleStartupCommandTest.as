...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.startup {
	...
	public class ModuleStartupCommandTest extends AbstractFabricationCommandTest {
		...
		public function ModuleStartupCommandTest(method:String) {
			super(method);
		}
		...
		public function testModuleStartupCommandHasValidType():void {
			assertType(ModuleStartupCommand, command);
		}
		
		public function testModuleStartupCommandRegistersRoutingSystemNotificationsAndConnectsToRouter():void {

...
package org.puremvc.as3.multicore.utilities.fabrication.components {
	 ...
	 */
	public class FlexModuleTest extends AbstractFabricationTest {
		
		public function FlexModuleTest(method:String) {
			super(method);
		}
		
		override public function initializeFabrication():void {
			fabrication = new FlexModule();
		...
		public function testFlexModuleHasValidType():void {

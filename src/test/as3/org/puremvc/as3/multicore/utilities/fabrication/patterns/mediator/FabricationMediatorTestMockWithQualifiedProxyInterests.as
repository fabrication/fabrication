...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.mediator {
	 ...
	 */
	public class FabricationMediatorTestMockWithQualifiedProxyInterests extends FabricationMediator implements IMockable {
		
		static public const NAME:String = "FabricationMediatorTestMockWithQualifiedProxyInterests";
		
		private var _mock:Mock;
		
		public function FabricationMediatorTestMockWithQualifiedProxyInterests(name:String = null, viewComponent:Object = null):void {
		...
		public function respondToProxy3(note:INotification):void {
			mock.respondToProxy3(note);
		}

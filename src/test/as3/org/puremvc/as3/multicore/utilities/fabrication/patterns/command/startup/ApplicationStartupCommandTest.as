...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.startup {
	...
	public class ApplicationStartupCommandTest extends AbstractFabricationCommandTest {
		...
		public function ApplicationStartupCommandTest(method:String) {
			super(method);
		}
		...
		public function testApplicationStartupCommandHasValidType():void {
			assertType(ApplicationStartupCommand, command);
		}
		
		public function testApplicationStartupCommandRegistersRoutingSystemNotifications():void {

...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.undoable {
	...
	public class SimpleUndoableCommandTest extends AbstractFabricationCommandTest {
		...
		public function SimpleUndoableCommandTest(method:String) {
			super(method);
		}
		...
		public function testSimpleUndoableCommandHasValidType():void {
			assertType(SimpleUndoableCommand, undoCommand);
			assertType(AbstractUndoableCommand, undoCommand);
		}
		
		public function testSimpleUndoableCommandStoresBeginState():void {
		...
		public function testSimpleUndoableCommandStoresCancelState():void {
		...
		public function testSimpleUndoableCommandInvokesCommitWithBeginStateDuringInitialExecution():void {
		...
		public function testSimpleUndoableCommandInvokesCommitWithCancelStateDuringUndoExecution():void {
		...
		public function testSimpleUndoableCommandInvokerCommitWithBeginStateDuringRedoExecution():void {
			var beginState:Object = new Object();
			var cancelState:Object = new Object();
			var mock:Mock = (simpleUndoableCommand as IMockable).mock;
		...
		public function testSimpleUndoableCommandResetsAfterDisposal():void {

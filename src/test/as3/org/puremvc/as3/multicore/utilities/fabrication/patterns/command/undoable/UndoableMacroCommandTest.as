...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.undoable {
	...
	public class UndoableMacroCommandTest extends AbstractFabricationCommandTest {
		...
		public function UndoableMacroCommandTest(method:String) {
			super(method);
		}
		...
		public function testUndoableMacroCommandHasValidType():void {
			assertType(UndoableMacroCommand, command);
			assertType(IUndoableCommand, command);
			assertType(AbstractUndoableCommand, command);
		}
		
		public function testUndoableMacroCommandAllowsAddingSubCommands():void {
		...
		public function testUndoableMacroCommandRunsInCorrectOrder():void {

...
package org.puremvc.as3.multicore.utilities.fabrication.components.mock {
	 ...
	 */
	public class FlashApplicationMock extends FlashApplication implements IMockable {

		public var _mock:Mock;
		
		public function FlashApplicationMock() {
			super();
		}
		...
		override public function get defaultRouteAddress():IModuleAddress {
			return mock.defaultRouteAddress;
		}
		
		override public function set router(router:IRouter):void {
			mock.router = router;
		}

...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.routing.test {
	...
	public class RouteMessageCommandTest extends AbstractFabricationCommandTest {
        ...
        [Test]
		public function routeMessageCommandHasValidType():void {
			assertType(RouteMessageCommand, command);
			assertType(SimpleFabricationCommand, command);
		}

        [Test]
		public function routeMessageCommandTranslatesDynamicTransportNotificationIntoSystemNotification():void {
        ...
        [Test]
		public function routeMessageCommandTranslatesCustomNotificationStoredInTransportNotificationIntoSystemNotificationOfThatCustomNotificationType():void {
        ...
        [Test]
		public function routeMessageCommandAttachesSourceRouterMessageToCustomNotificationsThatAreRouterMessageStoreAware():void {

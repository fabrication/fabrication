...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.command.undoable.test {
	...
	public class FabricationRedoCommandTest extends AbstractFabricationCommandTest {
        ...
        [Test]
        public function fabricationRedoCommandHasValidType():void {
			assertType(FabricationRedoCommand, command);
			assertType(SimpleFabricationCommand, command);
		}

        [Test]
		public function fabricationRedoCommandInvokesRedoOnFacadeWithNoArgsWhenStepsAreNotSpecified():void {
        ...
        [Test]
		public function fabricationRedoCommandInvokesRedoOnFacadeWithSpecifiedStepsWhenStepsAreSpecified():void {

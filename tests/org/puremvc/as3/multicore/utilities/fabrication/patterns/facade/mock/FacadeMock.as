...
package org.puremvc.as3.multicore.utilities.fabrication.patterns.facade.mock {
	 ...
	 */
	public class FacadeMock extends FabricationFacade implements IMockable {

		static public function getInstance(key:String):FacadeMock {
			if (instanceMap[key] == null) {
				instanceMap[key] = new FacadeMock(key);
			}
			
			return instanceMap[key] as FacadeMock;
		}
		 
		private var _mock:Mock;
		
		public function FacadeMock(key:String) {
			super(key);
		}
